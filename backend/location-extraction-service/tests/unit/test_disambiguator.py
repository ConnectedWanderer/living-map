...
class TestDisambiguator:
    ...
    def test_single_location_returns_that_location(self):
        locations = [
            {"text": "Paris", "lat": 48.8566, "lon": 2.3522, "country": "FR", "type": "GPE"},
        ]
    ...
    def test_first_mention_is_primary(self):
        locations = [
            {"text": "London", "lat": 51.5074, "lon": -0.1278, "country": "GB", "type": "GPE"},
            {"text": "Paris", "lat": 48.8566, "lon": 2.3522, "country": "FR", "type": "GPE"},
        ]
    ...
    def test_gpe_over_loc_priority(self):
        locations = [
            {"text": "Seine", "lat": 49.0, "lon": 2.5, "country": "FR", "type": "LOC"},
            {"text": "Paris", "lat": 48.8566, "lon": 2.3522, "country": "FR", "type": "GPE"},
        ]
    ...
    def test_skips_ungeocoded_locations(self):
        locations = [
            {"text": "Atlantis", "country": "XX", "type": "LOC"},
            {"text": "Paris", "lat": 48.8566, "lon": 2.3522, "country": "FR", "type": "GPE"},
        ]
    ...
    def test_country_name_resolution(self):
        locations = [
            {"text": "London", "lat": 51.5074, "lon": -0.1278, "country": "GB", "type": "GPE"},
            {"text": "Berlin", "lat": 52.5200, "lon": 13.4050, "country": "DE", "type": "GPE"},
        ]
